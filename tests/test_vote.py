...
class TestVote(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # self.user_john = User(username = "John", password = "banana", email = "john@doe.com" )

        # self.new_line = Line( line_content="I am Groot", group = self.group_pick_up, user=self.user_john)
    ...
    def test_num_vote(self):
        ...
        # self.user_jim = User(username = "John", password = "banana", email = "john@doe.com" )
